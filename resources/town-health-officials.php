...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
	<head>
		...
		<meta name="description" content="A directory of Vermont town health officials" />
		<title>Directory of town health officials | Vermont Rental Housing Codes</title>
	</head>
	<body id="resourcesBody">
		<div class="container_12">
			...
			<div id="header">
				...
				<ul id="primaryMenu">
					<li class="hidden"><a href="town-health-officials.php#content">Jump to content</a></li>
			...
			<div id="content">
				...
				<p id="breadcrumb">You are here: <a href="index.php">Resources</a> &gt; Directory of town health officials</p>
				<h1>Directory of town health officials</h1>
				<p>The Vermont Department of Health maintains a searchable database of town health officials. For information about the directory, <a href="mailto:vdhco@ahs.state.vt.us">email the department</a>.</p>
				
				<p><a class="outsideLink" href="http://healthvermont.gov/local/tho/tho_list.aspx">Find a town health official</a></p>
