...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
	<head>
		...
		<meta name="description" content="Search our site" />
		<title>Search | Vermont Rental Housing Codes</title>
	</head>
	<body id="searchBody">
		<div class="container_12">
			...
			<div id="header">
				...
				<ul id="primaryMenu">
					<li class="hidden"><a href="search.php#content">Jump to content</a></li>
			...
			<div id="content">
				...
				<p id="breadcrumb">You are here: Search</p>
					<h1>Search</h1>
					<div style="width:402px;margin-left:-6px;" id="searchFormBox">
						<div id="cse-search-form" style="width: 100%;">Loading</div>
						<script src="http://www.google.com/jsapi" type="text/javascript"></script>
						<script type="text/javascript">
						  google.load('search', '1', {language : 'en', style : google.loader.themes.MINIMALIST});
						  google.setOnLoadCallback(function() {
						    var customSearchControl = new google.search.CustomSearchControl('011646422950954028091:rzlkozul0mg');
					...
					<div id="cse" style="margin-left:-16px;" class="grid_10 alpha"></div>
