...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
	<head>
		...
		<meta name="description" content="What landlords need to know about selecting tenants" />
		<title>Selecting tenants | Landlords | Vermont Rental Housing Codes</title>
	</head>
	<body id="faqBody">
		<div class="container_12">
			...
			<div id="content">
				<p id="breadcrumb">You are here: <a href="../index.php">Who are you?</a> > <a href="index.php">Landlords</a> &gt; Selecting tenants</p>
				<div class="grid_10 prefix_1">
					...
					<div class="sidebar">
						...
						<ul>
							<li><a class="outsideLink" href="http://www.cvoeo.org/downloads/housing/fair_housing/FH handbook for LL's2009.pdf">Guide to Fair Housing Law For Landlords in Vermont</a></li>
							...
							<li><a class="outsideLink" href="http://www.cvoeo.org/downloads/housing/fair_housing/FH handbook for families2009.pdf">Guide to Fair Housing For Families in Vermont</a></li>
							<li><a class="outsideLink" href="http://portal.hud.gov/hudportal/HUD?src=/program_offices/fair_housing_equal_opp/FHLaws/yourrights">Department for Housing and Urban Development</a></li>
