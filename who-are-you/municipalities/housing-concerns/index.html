...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
	<head>
		...
		<meta name="description" content="Rental codes issues and areas of concern for town health officials" />
		<title>Issues and areas of housing concern | Municipalities | Vermont Rental Housing Codes</title>
	</head>
	<body id="faqBody">
		<div class="container_12">
			...
			<div id="content">
				<p id="breadcrumb">You are here: <a href="../../index.php">Who are you?</a> > <a href="../index.php">Municipalities</a> &gt; Issues and areas of housing concern</p>
				<div class="grid_10 prefix_1">

					<h1>Issues and areas of housing concern</h1>
					<p>The following section is dedicated to providing specific information for town health officers on how to approach a number of common issues and areas of concern for public safety in residential rental housing. Each issue is addressed in greater detail in the <a class="outsideLink" href="http://healthvermont.gov/local/tho/documents/TownHealthOfficerManual09.pdf">Town Health Officer Manual</a>. More information, including podcasts and slideshow materials can also be found on the <a class="outsideLink" href="http://healthvermont.gov/local/tho/tho.aspx">Vermont Department of Health website</a> in the Town Health Officer section.</a></p>
					<ul>
						<li><a href="sewage.php">Sewage</a></li>
						<li><a href="lead.php">Lead</a></li>
						<li><a href="water-safety.php">Water safety</a></li>
						<li><a href="air-quality.php">Air quality/mold</a></li>
						<li><a href="infestations.php">Infestations</a></li>
						<li><a href="../../../areas-of-interest/mobile-homes">Mobile homes</a></li>
					</ul>					
