...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
	<head>
		...
		<meta name="description" content="What tenants need to know before renting" />
		<title>Before renting | Tenants | Vermont Rental Housing Codes</title>
	</head>
	<body id="faqBody">
		<div class="container_12">
			...
			<div id="header">
				...
				<ul id="primaryMenu">
					<li class="hidden"><a href="before-renting.php#content">Jump to content</a></li>
				...
				<div class="grid_10 prefix_1">
					...
					<div class="sidebar">
						...
						<ul>
							...
							<li><a class="outsideLink" href="http://www.healthvermont.gov/sites/default/files/Env_THORental-Inspection.pdf">Vermont Department of Health's Inspection Checklist</a></li>
							<li><a class="outsideLink" href="http://www.leg.state.vt.us/statutes/sections.cfm?Title=09&amp;Chapter=137">Vermont Landlord and Tenant Law</a></li>
						...
						<li>File an EMP Compliance Statement every year with:
							<ul>
								...
								<li>The tenant</li>
										...
										<p><a class="more" href="lead-paint.php">Read more: The dangers of lead paint</a></p>
